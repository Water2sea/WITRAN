...
class Exp_Main(Exp_Basic):
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            intermediate_report = {}
            intermediate_report['default'] = vali_loss
            intermediate_report['test_loss'] = test_loss
            if intermediate_report['default'] < final_report['default']:
                final_report = intermediate_report
