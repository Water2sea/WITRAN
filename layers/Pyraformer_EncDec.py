...
class Decoder(nn.Module):
    ...
    def __init__(self, opt, mask):
        ...
        self.layers = nn.ModuleList([
            DecoderLayer(opt.d_model, opt.d_ff, opt.n_heads, opt.d_model // opt.n_heads, opt.d_model // opt.n_heads, dropout=opt.dropout, \
        ...
        if opt.embed_type == 'CustomEmbedding':
            ...
            self.dec_embedding = DataEmbedding(opt.enc_in, opt.d_model, 'timeF', opt.freq, opt.dropout)
